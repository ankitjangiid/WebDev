...
export default function PriceCard({
  ...
  return (
    // here header is "Suggested" which will be used only on last card, thats why we're checking if there is a header only then use it else use simple card
    <Card
